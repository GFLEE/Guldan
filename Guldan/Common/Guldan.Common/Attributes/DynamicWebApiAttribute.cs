...
namespace Guldan.Common
{
    ...
    public class DynamicWebApiAttribute : Attribute
    {
        ...
        {
            var remoteServiceAttr = type.GetTypeInfo().CheckIfContainAttribute<DynamicWebApiAttribute>();
        ...
        {
            var remoteServiceAttr = method.CheckIfContainAttribute<DynamicWebApiAttribute>();
            return remoteServiceAttr != null;
        }
